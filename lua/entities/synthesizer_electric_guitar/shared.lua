ENT.Base			= "synthesizer_base"
ENT.Type			= "anim"
ENT.PrintName		= "Synthesizer Electric-Guitar"
ENT.Author	        = "MacDGuy"
ENT.Contact			= "http://www.gmtower.org"
ENT.Purpose			= "Play on a real piano!"
ENT.Category		= "TNF Synthesizer"
ENT.Spawnable		= true
ENT.AdminSpawnable 	= true

ENT.Model		= Model( "models/tnf/synth.mdl" )
ENT.SoundDir	= "gmodtower/lobby/instruments/eguitar/"
